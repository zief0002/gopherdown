...
This project is a modified version Chester Ismay's [thesisdown](https://github.com/ismayc/thesisdown) package to provide support for the University of Minnesota's thesis.
...
This folder contains all of the Rmd files to be included in the frontmatter of your dissertation (e.g. abstract, acknowledgements, and dedication).
...
This folder contains the Rmd files for each chapter in your dissertation, including the appendices. 
Modify as you will.
